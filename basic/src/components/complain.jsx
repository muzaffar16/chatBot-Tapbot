...
import '../styles/popup.css'; // fixed this line
import uploadArea from '../assets/upload_area.png'; // adjust path if needed
...
const Complain = ({ isPopup = false, onClose, web_data }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/complain`, {
        method: 'POST',
        body: payload,
      });
